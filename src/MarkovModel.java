...
public class MarkovModel {
	...
	public MarkovModel(MarkovModel l) {
	...
	*/
	public MarkovModel(double[][] A, double[][] B, double[] pi) {
		this(A, B, pi, null);
	}
	 ...
	 * @param stateLabels
	 */
	public MarkovModel(double[][] A, double[][] B, double[] pi, String[] stateLabels) {
		this.A = A;
		this.B = B;
		this.pi = pi;
	...
	public String toString() {
		...
		output.append("                     " + stateLabel + "       Aa   Ak   As   Aa   Ak   As   Sa   Sk   Ss\n");
		for(int i = 0; i < N; i++) {
